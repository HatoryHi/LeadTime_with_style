...
<table class="table">
    ...
    <!--    --><? //= ' Количество принято равно списанному = ' . $k . ' для таблицы - ' . $table . '<br>'; ?>
    <!--    --><? //= ' Количество принято больше чем списанно = ' . $i . ' для таблицы - ' . $table . '<br>'; ?>
    <!--    --><? //= ' Количество принято меньше чем списанно = ' . $t . ' , ' . ' для таблицы - ' . $table . '<br>'; ?>
    </tbody>
</table>
